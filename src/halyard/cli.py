...
from halyard import cli_service
...
from halyard import cli_config

app.add_typer(cli_config.app)


# ---------------------------------------------------------------------------
# SQLite read-model cache (v2.14) and project registry
# ---------------------------------------------------------------------------

from halyard import cli_db, cli_projects
...
from halyard import cli_voyage
...
from halyard import cli_outcome
