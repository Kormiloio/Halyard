...
projects_app = typer.Typer(name="projects", help="Manage the Halyard project registry.")
...
@projects_app.command(name="forget")
def projects_forget(
...
# ---------------------------------------------------------------------------
# halyard outcome — PR resolution and outcome reporting
# ---------------------------------------------------------------------------

outcome_app = typer.Typer(name="outcome", help="Resolve AI sessions to PR outcomes.")
app.add_typer(outcome_app)


@outcome_app.command(name="sync")
def outcome_sync(
...
@outcome_app.command(name="report")
...
@outcome_app.command(name="attribute")
